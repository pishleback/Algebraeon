...
impl PentagonWgpu {
    fn new(wgpu_state: &WgpuState, camera_bind_group_layout: &BindGroupLayout) -> Self {
        let vertex_buffer =
            wgpu_state
                .device
...
impl Canvas2DWindowState {
    fn new(window: Arc<Window>) -> Self {
        ...
        Self {
            pentagon: PentagonWgpu::new(&wgpu_state, &camera_bind_group_layout),
            wgpu_state,
            camera_uniform,
            camera_bind_group,
            camera_buffer,

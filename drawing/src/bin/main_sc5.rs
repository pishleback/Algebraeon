...
fn main() {
    ...
    // let x = parse_shape(
    //     "((Polygon((0, 0), (4, 0), (4, 1), (3, 1), (3, -1), (2, -1), (2, 2), (1, 2)) | Polygon((5/2, 0/2), (4/2, 1/2), (3/2, 0/2), (4/2, -1/2))) \\ (Loop((0, 0), (1, 1), (11/4, -1/4)) \\ (1/3, 1/3))) + Lines((0, 0), (1/10, 1/10))",
    // );

    let x = parse_shape(
        "ConvexHull((-1, -1), (1, -1), (1, 1), (-1, 1)) + ConvexHull((-1, 0), (0, -1), (1, 0), (0, 1))",
    );

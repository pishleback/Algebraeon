...
/// For generating pseudo-random numbers.
pub struct Rng {
    rng: malachite::base::num::random::RandomPrimitiveInts<u64>,
}
...
impl Rng {
    ...
    pub fn new(seed: u128) -> Self {
        ...
        let seed = malachite::base::random::Seed::from_bytes(bytes);
        Self {
            rng: malachite::base::num::random::random_primitive_ints(seed),
        }
    }
    ...
    pub fn uniform_random_natural_less_than(&mut self, n: impl Borrow<Natural>) -> Natural {
        Natural::from_malachite(malachite::natural::random::get_random_natural_less_than(
            &mut self.rng,
    ...
    pub fn uniform_random_integer_from_inclusive_range(
        ...
        Integer::from_malachite(
            malachite::integer::random::get_uniform_random_integer_from_inclusive_range(
                &mut self.rng,
                a.to_malachite(),
                b.to_malachite(),
            ),

...
pub trait PermutationsSignature<Set: SetSignature>: GroupSignature {
    ...
    fn new_swap(self: &Rc<Self>, a: Set::Elem, b: Set::Elem) -> Result<Self::Elem, ()> {
    ...
    #[allow(clippy::result_unit_err)]
    fn new_cycles(self: &Rc<Self>, cycles: Vec<Vec<Set::Elem>>) -> Result<Self::Elem, ()> {
    ...
    fn cycle_shape(self: &Rc<Self>, perm: &Self::Elem) -> HashMap<usize, usize> {
    ...
    fn is_even(self: &Rc<Self>, perm: &Self::Elem) -> bool {
    ...
    fn is_odd(self: &Rc<Self>, perm: &Self::Elem) -> bool {
        !self.is_even(perm)
    }
}

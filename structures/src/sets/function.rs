...
{
    fn image(self: &Arc<Self>, x: &Domain::Elem) -> Range::Elem;
}
...
pub trait EndofunctionMorphism<X: SetSignature + EqSignature>: FunctionMorphism<X, X> {
    ...
    fn is_fixed_point(self: &Arc<Self>, x: X::Elem) -> bool {

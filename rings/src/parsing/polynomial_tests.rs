...
fn test_rational_polynomial_big_constant() {
    ...
    assert_eq!(
        result,
        Polynomial::from_coeffs(vec![
            Rational::from_str("123456789123456789123456789123456789123456789123456789123456789/123456789123456789123456789123456789123456789123456789123456789").unwrap()
        ])
    );
}

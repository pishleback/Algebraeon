...
pub struct QuaternionOrderZBasis<ANF: AlgebraicNumberFieldSignature> {
    algebra: Rc<QuaternionAlgebraStructure<ANF>>,
    ...
    for QuaternionOrderZBasis<ANF>
{
    ...
    fn scalar_mul(self: &Rc<Self>, a: &Self::Elem, x: &Integer) -> Self::Elem {
...
impl<ANF: AlgebraicNumberFieldSignature> QuaternionOrderZBasis<ANF> {
    #[allow(unused)]
    fn check_basis(self: &Rc<Self>) -> bool {
...
mod tests {
    ...
    fn test_lipschitz_order() {
        ...
        let order = Rc::new(QuaternionOrderZBasis {
            algebra: h,

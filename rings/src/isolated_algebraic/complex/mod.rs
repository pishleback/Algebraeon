...
impl AdditionSignature for ComplexAlgebraicCanonicalStructure {
    fn add(self: &Rc<Self>, alg1: &Self::Elem, alg2: &Self::Elem) -> Self::Elem {
...
impl MultiplicationSignature for ComplexAlgebraicCanonicalStructure {
    fn mul(self: &Rc<Self>, alg1: &Self::Elem, alg2: &Self::Elem) -> Self::Elem {
...
impl CharZeroRingSignature for ComplexAlgebraicCanonicalStructure {
    fn try_to_int(self: &Rc<Self>, alg: &Self::Elem) -> Option<Integer> {
        match alg {
...
{
    fn all_roots(self: &Rc<Self>, polynomial: &Polynomial<Integer>) -> Vec<ComplexAlgebraic> {
...
{
    fn all_roots(self: &Rc<Self>, polynomial: &Polynomial<Rational>) -> Vec<ComplexAlgebraic> {
        polynomial.all_complex_roots()
    }
}

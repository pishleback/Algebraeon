...
impl MultiplicationSignature for RealAlgebraicCanonicalStructure {
    fn mul(self: &Rc<Self>, elem1: &Self::Elem, elem2: &Self::Elem) -> Self::Elem {
...
{
    fn all_roots(self: &Rc<Self>, polynomial: &Polynomial<Integer>) -> Vec<RealAlgebraic> {
...
{
    fn all_roots(self: &Rc<Self>, polynomial: &Polynomial<Rational>) -> Vec<RealAlgebraic> {
        polynomial.all_real_roots()
    }
}
